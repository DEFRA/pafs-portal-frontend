...
/**
 * Map each input/display step to the route template of its preceding page.
 * Used to build the "Back" link for pages after the info/guidance screens.
 */
const PREV_PAGE_ROUTE_MAP = {
  [PROJECT_STEPS.CARBON_COST_BUILD]: ROUTES.PROJECT.EDIT.CARBON_PREPARE,
  [PROJECT_STEPS.CARBON_COST_OPERATION]: ROUTES.PROJECT.EDIT.CARBON_COST_BUILD,
  [PROJECT_STEPS.WHOLE_LIFE_CARBON]: ROUTES.PROJECT.EDIT.CARBON_COST_OPERATION,
  [PROJECT_STEPS.CARBON_COST_SEQUESTERED]:
    ROUTES.PROJECT.EDIT.WHOLE_LIFE_CARBON,
  [PROJECT_STEPS.CARBON_COST_AVOIDED]:
    ROUTES.PROJECT.EDIT.CARBON_COST_SEQUESTERED,
  [PROJECT_STEPS.NET_CARBON]: ROUTES.PROJECT.EDIT.CARBON_COST_AVOIDED,
  [PROJECT_STEPS.CARBON_SAVINGS_NET_ECONOMIC_BENEFIT]:
  ...
  [PROJECT_STEPS.CARBON_SUMMARY]:
    ROUTES.PROJECT.EDIT.CARBON_OPERATIONAL_COST_FORECAST,
  [PROJECT_STEPS.CARBON_IMPACT_ASSESSMENT]: ROUTES.PROJECT.EDIT.CARBON_SUMMARY
}

/**
 * Get the route template for the page that precedes the given step.
 * Falls back to the project overview if no previous page is mapped.
 */
export const getPreviousRouteForStep = (step) =>
  PREV_PAGE_ROUTE_MAP[step] || ROUTES.PROJECT.OVERVIEW
