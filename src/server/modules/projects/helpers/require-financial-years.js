 ...
 * page asking them to set the dates before continuing with important dates
 * or funding sources.
 *
 * Attach this pre-handler to every GET/POST route inside the important-dates
 * and funding-sources plugins so that legacy projects without dates cannot
 * enter either section.
 */
