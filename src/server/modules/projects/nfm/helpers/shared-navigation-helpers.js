...
/**
 * Maps each NFM measure to its detail page route
 */
export const MEASURE_TO_ROUTE = {
...
/**
 * Canonical NFM measure order used by selected-measures UI and follow-up navigation.
 */
export const NFM_MEASURE_ORDER = [
...
/**
 * Maps each NFM detail step to its corresponding measure value.
 */
export const STEP_TO_MEASURE = {
