export const PROJECT_PAYLOAD_FIELDS = {
  ...
  PSO_NAME: 'psoName',
  RFCC_NAME: 'rfccName',
  EA_AREA_NAME: 'eaAreaName',
  MODERATION_FILENAME: 'moderationFilename',
  ...
  INTERNAL_DRAINAGE_BOARDS: 'internalDrainageBoards',
  ...
  GROWTH_FUNDING: 'growthFunding',
  NOT_YET_IDENTIFIED: 'notYetIdentified',
  FUNDING_SOURCES_VISITED: 'fundingSourcesVisited',
