...
export const ROUTES = {
  ...
  PROJECT: {
    ...
    EDIT: {
      ...
      FINANCIAL_YEAR_WARNING: `/project/{referenceNumber}/${PROJECT_STEPS.FINANCIAL_YEAR_WARNING}`,
      ...
      NFM: {
        INCLUSION: `/project/{referenceNumber}/${PROJECT_STEPS.NFM_INCLUSION}`,
        ...
        FLOODPLAIN_WETLAND_RESTORATION: `/project/{referenceNumber}/${PROJECT_STEPS.NFM_FLOODPLAIN_WETLAND_RESTORATION}`,
        ...
        LAND_USE_WOODLAND_FOR_TIMBER_HARVESTING: `/project/{referenceNumber}/${PROJECT_STEPS.NFM_LAND_USE_WOODLAND_FOR_TIMBER_HARVESTING}`,
        LAND_USE_MOUNTAIN_MOORS_AND_HEATH: `/project/{referenceNumber}/${PROJECT_STEPS.NFM_LAND_USE_MOUNTAIN_MOORS_AND_HEATH}`,
        LAND_USE_PEATLAND_DEGRADED: `/project/{referenceNumber}/${PROJECT_STEPS.NFM_LAND_USE_PEATLAND_DEGRADED}`,
      ...
      FUNDING_SOURCES: {
        FUNDING_SOURCES_SELECTION: `/project/{referenceNumber}/${PROJECT_STEPS.FUNDING_SOURCES}`,
        ADDITIONAL_FUNDING_SOURCES_SELECTION: `/project/{referenceNumber}/${PROJECT_STEPS.FUNDING_SOURCES_ADDITIONAL}`,
        PUBLIC_SECTOR_CONTRIBUTORS: `/project/{referenceNumber}/${PROJECT_STEPS.FUNDING_SOURCES_PUBLIC_CONTRIBUTORS}`,
        PUBLIC_SECTOR_CONTRIBUTORS_DELETE: `/project/{referenceNumber}/${PROJECT_STEPS.FUNDING_SOURCES_PUBLIC_CONTRIBUTORS}/delete`,
        PRIVATE_SECTOR_CONTRIBUTORS: `/project/{referenceNumber}/${PROJECT_STEPS.FUNDING_SOURCES_PRIVATE_CONTRIBUTORS}`,
        PRIVATE_SECTOR_CONTRIBUTORS_DELETE: `/project/{referenceNumber}/${PROJECT_STEPS.FUNDING_SOURCES_PRIVATE_CONTRIBUTORS}/delete`,
        OTHER_ENVIRONMENT_AGENCY_CONTRIBUTORS: `/project/{referenceNumber}/${PROJECT_STEPS.FUNDING_SOURCES_OTHER_EA_CONTRIBUTORS}`,
        OTHER_ENVIRONMENT_AGENCY_CONTRIBUTORS_DELETE: `/project/{referenceNumber}/${PROJECT_STEPS.FUNDING_SOURCES_OTHER_EA_CONTRIBUTORS}/delete`,
        ESTIMATED_SPEND: `/project/{referenceNumber}/${PROJECT_STEPS.FUNDING_SOURCES_ESTIMATED_SPEND}`
      }
    }
  },
